...
)) {Object.defineProperty(Element.prototype,"dataset",{get:function(){for(var t=this,e=this.attributes,r={},n=0;n<e.length;n++){var a=e[n];if(a&&a.name&&/^data-\w[\w-]*$/.test(a.name)){var i=a.name,u=a.value,s=i.substr(5).replace(/-./g,function(t){return t.charAt(1).toUpperCase()});Object.defineProperty(r,s,{enumerable:!0,get:function(){return this.value}.bind({value:u||""}),set:function o(t,e){void 0!==e?this.setAttribute(t,e):this.removeAttribute(t)}.bind(t,i)})}}return r}});}Element.prototype.matches=Element.prototype.webkitMatchesSelector||Element.prototype.oMatchesSelector||Element.prototype.msMatchesSelector||Element.prototype.mozMatchesSelector||function e(t){for(var o=this,r=(o.document||o.ownerDocument).querySelectorAll(t),c=0;r[c]&&r[c]!==o;)++c;return!!r[c]};Element.prototype.closest=function e(n){for(var t=this;t;){if(t.matches(n))return t;t="SVGElement"in window&&t instanceof SVGElement?t.parentNode:t.parentElement}return null};if (!("Element"in self&&"inert"in Element.prototype
